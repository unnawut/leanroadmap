            ...
            .map((cta, index) => (
              ...
              >
                ...
                <div className="relative flex-1 min-w-0">
                  <div className="font-semibold text-slate-800 group-hover:text-slate-900 transition-colors truncate">
                    {cta.title}
                  </div>
                  {cta.description && (
                    <div className="text-sm text-slate-500 truncate">{cta.description}</div>
                  )}
                </div>
